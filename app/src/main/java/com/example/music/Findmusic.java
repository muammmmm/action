...
public class Findmusic {
    public List<Music> getmusics(ContentResolver contentResolver) {
        Cursor cursor = contentResolver.query(//应用程序之间数据共享，存储和检索数据
                MediaStore.Audio.Media.EXTERNAL_CONTENT_URI, null, null, null, MediaStore.Audio.Media.DEFAULT_SORT_ORDER);//外部内容URI，默认排序顺序
